...
VSIM_BENDER   += -t test -t rtl -t simulation -t vsim -t snitch_cluster
...
VCS_BENDER   += -t test -t rtl -t simulation -t vcs -t snitch_cluster
...
VLT_BENDER   += -t rtl -t snitch_cluster
