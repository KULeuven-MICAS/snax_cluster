...
module snax_simbacore_cluster_wrapper (
  ...
  localparam int unsigned SnaxNarrowTcdmPorts     [2] = '{18, 16};
  ...
  snax_simbacore_wrapper # (
    ...
    // TCDM ports
    //-----------------------------
    .snax_tcdm_req_o  ( snax_tcdm_req[17:0] ),
    .snax_tcdm_rsp_i  ( snax_tcdm_rsp[17:0] )
  );
  ...
  snax_simbacore_cluster_xdma_wrapper # (
    ...
    // TCDM ports
    //-----------------------------
    .tcdm_req_o  ( snax_tcdm_req[33:18] ),
    .tcdm_rsp_i  ( snax_tcdm_rsp[33:18] )
  );
