...
int test_phase1() {
    ...
    if (snrt_is_dm_core()) {
        ...
        snrt_dma_start_1d(ptr_iscore_out, M1_iscore_bias, M1_length_iscore_out);
        snrt_dma_wait_all();
    }
...
int test_phase2() {
    ...
    if (snrt_is_dm_core()) {
        ...
        snrt_dma_start_1d(ptr_oscore_weight, M2_oscore_weight, M2_length_oscore_weight);
        ...
        snrt_dma_start_1d(ptr_iscore_weight, M2_iscore_weight, M2_length_iscore_weight);
        snrt_dma_start_1d(ptr_iscore_out, M2_iscore_bias, M2_length_iscore_out);  // Load bias in psums
        snrt_dma_wait_all();
    }
