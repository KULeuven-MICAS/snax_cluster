...
def emit_header_file(**kwargs):
    ...
    emit += [format_scalar_definition("uint32_t", "silu_inv_scale", int(inv_scale.view(np.uint32)))]
    emit += [format_vector_definition("int8_t", "silu_golden_i8", q_i8, alignment=64)]
    return "\n\n".join(emit)
