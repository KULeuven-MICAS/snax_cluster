...
def emit_matmul_data(**kwargs):
    ...
    data_str += [format_scalar_definition("uint32_t", "data_type", kwargs["data_type"])]
    ...
    a_array_width = kwargs["snax_streamer_gemmX_core_template"]["snax_acc_cfg"][
        "snax_gemmx_array_a_width"
    ]
    b_array_width = kwargs["snax_streamer_gemmX_core_template"]["snax_acc_cfg"][
        "snax_gemmx_array_b_width"
    ]
    c_array_width = kwargs["snax_streamer_gemmX_core_template"]["snax_acc_cfg"][
        "snax_gemmx_array_c_d_width"
    ]
    d_array_width = c_array_width
    snax_gemmx_serial_c_d_width = kwargs["snax_streamer_gemmX_core_template"][
        "snax_acc_cfg"
    ]["snax_gemmx_serial_c_d_width"]
    ...
    c_spatial_bound_0 = snax_gemmx_serial_c_d_width / bankWidth
    # temporal settings
    # serial input for C
    data_str += [
        format_scalar_definition(
            "int32_t",
            "Ctlbound0",
            c_array_width / snax_gemmx_serial_c_d_width,
        )
    ]
    data_str += [
        format_scalar_definition(
    ...
    C_enabled_channel_CSR_num = int(math.ceil(snax_gemmx_serial_c_d_width / bankWidth / 32))
    ...
    d_spatial_bound_0 = snax_gemmx_serial_c_d_width / bankWidth
    # temporal settings
    data_str += [
        format_scalar_definition(
            "int32_t",
            "D32tlbound0",
            d_array_width / snax_gemmx_serial_c_d_width,
        )
    ]
    data_str += [
        format_scalar_definition(
    ...
    D_enabled_channel_CSR_num = int(
        math.ceil(snax_gemmx_serial_c_d_width / bankWidth / 32)
    )
