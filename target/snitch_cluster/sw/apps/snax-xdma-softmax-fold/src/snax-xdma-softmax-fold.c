...
//
// xDMA FP16 multi-row softmax, A/B: per row,
// out[r,:] = exp(x[r,:] - max[r]) / Sexp[r]. Same kernel, tensor and golden as
// snax-xdma-softmax-multirow; this app runs the DEPLOYED path and a
...
// snax-xdma-softmax-multirow exactly at 4x64 (max 197, sub 144, exp 86, sum
