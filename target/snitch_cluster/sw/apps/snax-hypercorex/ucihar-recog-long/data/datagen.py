...
asm_path = current_directory + "/ucihar_recog.txt"
...
# Number of classes in the ucihar dataset
NUM_CLASSES = 6
...
def main():
    ...
    # Loading data first
    assoc_mem_fp = hypercorex_path + "/hemaia/trained_am/hypx_ucihar_am.txt"
