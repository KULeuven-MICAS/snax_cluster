...
//
// Program: Hypercorex Test DNA Recognition
//-------------------------------
...
int main() {
    ...
    //-------------------------------
    // uint32_t final_predictions = 24;
    // uint32_t num_features = 60;
    ...
    for (uint32_t i = 0; i < bank_num; i++) {
        ...
        if (snrt_is_compute_core()) {
            ...
            hypercorex_set_auto_counter_start_b(8);
    ...
    if (snrt_is_compute_core()) {
        ...
        hypercorex_set_streamer_lowdim_predict(
            ...
            1,                        // Spatial stride
            // Loop bounds from inner to outer
            8, final_sub_num_predictions, 1, 1,
            // Strides from inner to outer
            8, 256, 0, 0);
