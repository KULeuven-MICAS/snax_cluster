...
class XDMADataPath(readerParam: XDMAParam, writerParam: XDMAParam, clusterName: String = "unnamed_cluster")
  ...
  val io = IO(new Bundle {
    ...
    /** O5 and the starvation watchdog, on their way to a software-readable register. Both were dead-ended at the data
      * switch: the hardware knew, and nothing above it could ask.
      */
